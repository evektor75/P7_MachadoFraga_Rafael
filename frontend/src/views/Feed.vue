                    ...
                    <div class="card-body">
                        <form action="/new" method="post">
                            ...
                            <div class="input-group form-group">
                                <label for="post" class="mr-1">Quoi de neuf ? </label>
                            ...
                            <div class="form-group">
                                <input type="submit" value="Publier" class="btn float-right login_btn publish_btn mt-2" @click.prevent="createPost">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="comment mt-1">
                                <div class="createComment d-flex">
                                    ...
                                    <button type="submit" class="btn btn-primary" value="Commenter" @click.prevent="createComment(item.id)"></button>
                                </div>
                                <div class="displayComments">
                                    <div class="comment d-flex" v-for="comment in item.Comments" :key="comment.id">
                                            ...
                                            <div class="moderationComment" v-if="item.userId==comment.userId || user.isAdmin ==true">
